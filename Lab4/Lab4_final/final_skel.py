...
class final_topo(Topo):
  def build(self):
    ...
    self.addLink(h1, s1, port1=0, port2=1)     ## Add a link
    self.addLink(s1,s4,  port1=11, port2=21)     ## Add a link


    self.addLink(h2, s2, port1=0, port2=1)    ## Add a link
    self.addLink(s2,s4,  port1=12, port2=22)    ## Add a link

    self.addLink(h3, s3, port1=0, port2=1)    ## Add a link
    self.addLink(s3,s4,  port1=13, port2=23)    ## Add a link

    self.addLink(h4, s4, port1=4, port2=1)   ## Add a link    

    self.addLink(h5,s5, port1=0, port2=1)     ## Add a link
    self.addLink(s5,s4,  port1=14, port2=24)    ## Add a link
